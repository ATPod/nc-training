...
public class AdministratorConsole {
    ...
    /*final static Logger logger = Logger.getLogger(AdministratorConsole.class);
    ...
    private static void addProduct() throws IdRepeatException, DAOException{
        System.out.print(AdministratorService.getAllAdministrators());
        int id = getID();
    ...
    public static void main (String [] args) throws IOException, DAOException, ClassNotFoundException, IdRepeatException, NotFoundException{
